# Crear TrainResponse, MetricsResponse, PredictResponse
...
class PredictRequest(BaseModel):
    ...
    class Config:
        kson_schema_extra ={
            'exemple': {'TV': 230.1, 'Radio':37.8, 'Newspaper':69.2}
        }
# cuales son las columnas y que datos tienes


class PredictResponse(BaseModel):
    predicted_sales : float
    model_version : str
#solo predicciones y version
